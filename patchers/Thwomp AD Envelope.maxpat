...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 360.0, 90.0, 24.0, 20.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 195.0, 87.0, 20.0 ],
					"text" : "0, $1 $2 $3 $4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 165.0, 89.0, 20.0 ],
					"text" : "pack 1. 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 180.0, 225.0, 36.0, 20.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 300.0, 120.0, 36.0, 20.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 300.0, 90.0, 49.0, 20.0 ],
					"text" : "t signal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 300.0, 60.0, 73.0, 20.0 ],
					"text" : "route signal"
				}
