...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 480.0, 64.0, 32.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 448.0, 64.0, 32.0, 16.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 448.0, 80.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "val1", "val2" ],
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 440.0, 8.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
							"parameter_unitstyle" : 4,
...
, 			{
				"box" : 				{
					...
					"pattrstorage" : "Thwomp",
					"presentation" : 1,
					"presentation_rect" : [ 448.0, 96.0, 64.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 40.0, 0.0, 472.0, 168.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-17::obj-2::obj-11" : [ "On[10]", "On", 0 ],
			...
			"obj-1::obj-3::obj-2::obj-11" : [ "On[7]", "On", 0 ],
			...
			"obj-1::obj-44::obj-2::obj-11" : [ "On[1]", "On", 0 ],
			...
			"obj-1::obj-1::obj-2::obj-11" : [ "On[4]", "On", 0 ],
