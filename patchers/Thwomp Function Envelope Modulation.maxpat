...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "(Signal/Float) Modulation Amount",
					"id" : "obj-6",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "(Signal) Modulated Frequency, Bang Triggers Envelope",
					"id" : "obj-10",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
