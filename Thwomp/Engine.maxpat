        ...
        "boxes": [
            {
                "box": {
                    ...
                    "patcher": {
                        ...
                        "classnamespace": "box",
                        "rect": [ 2007.0, 419.0, 1000.0, 780.0 ],
                        "gridsize": [ 8.0, 8.0 ],
                        "gridsnaponopen": 2,
                        "objectsnaponopen": 0,
                        "subpatcher_template": "roben-kleene-max-for-live",
            ...
            },
            {
                "box": {
                    ...
                    "patcher": {
                        ...
                        "classnamespace": "box",
                        "rect": [ 1380.0, 177.0, 695.0, 1083.0 ],
                        "gridsize": [ 8.0, 8.0 ],
                        "gridsnaponopen": 2,
                        "objectsnaponopen": 0,
                        "subpatcher_template": "roben-kleene-max-for-live",
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "bang" ],
                                    "patching_rect": [ 56.0, 96.0, 21.0, 20.0 ],
                                    "text": "t b"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "signal" ],
                                    "patching_rect": [ 8.0, 96.0, 44.0, 20.0 ],
                                    "text": "t signal"
                                }
                            },
                            {
