        ...
        "boxes": [
            {
                "box": {
                    ...
                    "patching_rect": [ 160.0, 88.0, 40.0, 22.0 ],
                    "text": "t i i i"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 8.0, 64.0, 137.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 4,
                    "outlettype": [ "", "", "", "" ],
                    "patching_rect": [ 272.0, 8.0, 56.0, 22.0 ],
                    "restore": {
                        "#1-Note": [ 1.0 ]
                    },
                    "text": "autopattr",
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 168.0, 240.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 160.0, 64.0, 44.0, 15.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "int" ],
                    "patching_rect": [ 184.0, 136.0, 34.0, 22.0 ],
                    "text": "* -48"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 184.0, 168.0, 66.0, 20.0 ],
                    "text": "offset 0 $1"
                }
            },
            {
