        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 16.0, 608.0, 29.5, 22.0 ],
                    "text": "/~ 2"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 16.0, 576.0, 29.5, 22.0 ],
                    "text": "+~"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 16.0, 400.0, 48.0, 160.0 ],
                    "presentation": 1,
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 72.0, 608.0, 132.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "float" ],
                    "parameter_enable": 1,
                    "patching_rect": [ 72.0, 552.0, 41.0, 48.0 ],
                    "presentation": 1,
